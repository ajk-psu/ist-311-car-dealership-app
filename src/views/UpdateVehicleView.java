...
public class UpdateVehicleView extends JFrame 
{
	
	private JFrame updateVehicleFrame;
	...
	{	
		...
		updateVehicleFrame = new JFrame("Update Vehicle Details");
		updateVehicleFrame.setResizable(false);
		updateVehicleFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		updateVehicleFrame.setBounds(100, 100, 380, 455);
		
		// homePane Properties
		mainPane = new JPanel();
		mainPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		mainPane.setLayout(null);
		updateVehicleFrame.setContentPane(mainPane);
		...
		// txtMake Properties
		btnAddVehicle = new JButton("Update Vehicle Details");
		btnAddVehicle.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnAddVehicle.setBounds(95, 364, 155, 41);
	...
	{
		updateVehicleFrame.setVisible(visible);
	}
