...
public class VehicleDetailsView extends JFrame 
{
	...
	{	
		...
		addVehicleFrame = new JFrame("Vehicle Details");
		...
		JLabel lblWelcome = new JLabel("Showing detailed vehicle information");
		...
		btnUpdateVehicle.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnUpdateVehicle.setBounds(10, 405, 129, 41);
		mainPane.add(btnUpdateVehicle);
		
		btnRemoveVehicle = new JButton("Remove Vehicle");
		btnRemoveVehicle.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnRemoveVehicle.setBounds(225, 405, 129, 41);
		...
		lblvehicleID.setHorizontalAlignment(SwingConstants.LEFT);
		lblvehicleID.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblvehicleID.setBounds(10, 43, 79, 14);
		mainPane.add(lblvehicleID);
	}
	...
	{
		btnUpdateVehicle.addActionListener(listener);
	}
